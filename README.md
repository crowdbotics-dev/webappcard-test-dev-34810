...
## Project Structure
    ...
    ├── webappcard_test_dev_34810  # Django project configurations
...
1. Clone this repo and `cd webappcard_test_dev_34810`
...
2. Clone this repo and `cd webappcard_test_dev_34810`
